...
class Metadata:
    def __init__(self, dcp_metadata: CData):
    ...
    def create(cls: Type[Metadata], name: bytes, acc: bytes) -> Metadata:
        return cls(lib.dcp_metadata_create(name, acc))

    @property
    def acc(self) -> bytes:
        return ffi.string(lib.dcp_metadata_acc(self._dcp_metadata))

    @property
    def name(self) -> bytes:
        return ffi.string(lib.dcp_metadata_name(self._dcp_metadata))
